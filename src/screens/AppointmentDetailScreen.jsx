          ...
          { text: 'No', style: 'cancel' },
          {
            ...
            onPress: () => {
              dispatch(cancelAppointment(appointment.id))
                .unwrap()
                .then(() => {
                  Alert.alert(t('global.success'), t('appointmets.alert.cancel'));
                  navigation.goBack();
                })
                .catch((err) => {
          ...
          <View className="p-5">
            ...
            <View className={`mb-6 ${cardClass} rounded-xl p-4`}>
              <View className="flex-row justify-between items-center">
                ...
                {/* Badge de estado */}
                <View
                  className={`flex-row items-center ${statusConfig.bgColor} border ${statusConfig.borderColor} px-3 py-2 rounded-full`}>
                  <Icon
